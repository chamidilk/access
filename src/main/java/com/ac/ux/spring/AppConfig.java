...
@Configuration
//@ComponentScan(basePackages = {"com.ac.ux.listener"})
//@PropertySource(value = {"file:${ac.repo.location}/app.properties"}, ignoreResourceNotFound = false)
...
public class AppConfig {
    ...
    private CredentialsProvider provider() {
        ...
        UsernamePasswordCredentials credentials =
                new UsernamePasswordCredentials(env.getProperty("ac.username"), env.getProperty("ac.password"));
